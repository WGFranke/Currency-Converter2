  ...
  return (
    <React.Fragment>
      ...
      <footer className="p-3 bg-light">
        ...
        <div>
          <span className="mr-3 text-secondary">Built by <a href="https://github.com/WGFranke/Currency-Converter" target="_blank" rel="noopener noreferrer">Altcademy</a> with ☕ and 💜</span>
        </div>
      </footer>
    </React.Fragment>
  );
